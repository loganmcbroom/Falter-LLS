...
-- ---@return AudioVec
-- function AudioVec.load_from_file( 
-- 	filename
-- 	) end
...
-- ---@return AudioVec
-- function AudioVec.create_empty_with_length( 
-- 	length,
-- 	num_channels,
-- 	sample_rate 
-- 	) end
...
-- ---@param sample_rate? number
-- ---@return AudioVec
-- function AudioVec.create_empty_with_frames( 
-- 	num_frames,
-- 	num_channels,
-- 	sample_rate 
-- 	) end
...
---@return nil
function AudioVec:save_spectrum_to_bmp(
	filename,
	width, 
	height,
	smoothing_frames
...
---@return PVVec
function AudioVec:convert_to_PV(
	window_size,
	hop, 
	dft_size
	) end

---For stereo inputs this is identical to AudioVec::convert_to_PV, but converts the audio to mid-side first.
---@param window_size? integer
---@param hop? integer
---@param dft_size? integer
---@return PVVec
function AudioVec:convert_to_ms_PV(
	window_size,
	hop, 
	dft_size
	) end
...
---@return AudioVec
function AudioVec:convert_to_mid_side(
	) end

---Convert a stereo mid/side Audio into a left/right Audio
---@return AudioVec
function AudioVec:convert_to_left_right(
	) end
...
---@return AudioVec
function AudioVec:convert_to_stereo(
	) end
...
---@return AudioVec
function AudioVec:convert_to_mono(
 	) end
...
---@return function[]
function AudioVec:convert_to_function(
	) end
...
---@return AudioVec[]
function AudioVec:split_channels(
	) end

---Combine the input mono channels into a sigle multichannel Audio.
---@return Audio
function AudioVec:combine_channels( 
	channels 
	) end
...
---@param window_size? integer
---@return number[]
function AudioVec:get_local_wavelength( 
 	channel,
 	start_frame, 
 	window_size
	) end
...
-- function AudioVec:get_local_wavelengths( 
-- 	channel, 
-- 	start, 
-- 	end,
-- 	window_size,
...
-- 	*/
-- ---@return number
-- function AudioVec:get_average_wavelength( 
...
---@return number[]
function AudioVec:get_local_frequency( 
	channel, 
	start_frame, 
	window_size 
    ) end
...
---@return function[]
function AudioVec:get_amplitude_envelope(
	window_width
    ) end

---Returns a function that approximates the frequency envelope over time.
---@return function[]
function AudioVec:get_frequency_envelope( 
    ) end
...
---@return AudioVec
function AudioVec:modify_boundaries( 
 	start_time_change, 
	end_time_change 
    ) end
...
---@return AudioVec
function AudioVec:remove_edge_silence( 
 	non_silent_level 
    ) end
...
---@return AudioVec
function AudioVec:remove_silence(
	non_silent_level,
	minimum_gap
    ) end
...
---@return AudioVec
function AudioVec:modify_volume( 
 	gain
    ) end
...
---@return AudioVec
function AudioVec:invert_phase(
    ) end
...
---@return AudioVec
function AudioVec:add_moisture(
	amount,
	frequency,
	skew,
	waveform
...
---@return AudioVec
function AudioVec:stereo_spatialize_variable( 
	position 
    ) end
...
---@return AudioVec
function AudioVec:stereo_spatialize( 
	position 
    ) end 
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_1pole_lowpass(
	cutoff,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_1pole_highpass(
	cutoff,
	order
    ) end
...
---@param order? integer
---@return AudioVec[]
function AudioVec:filter_1pole_split(
	cutoff,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_1pole_lowshelf(
	cutoff,
	gain,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_1pole_highshelf(
	cutoff,
	gain,
	order
    ) end
...
-- -- */
-- function AudioVec:filter_1pole_repeat(
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_lowpass(
	cutoff,
	damping,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_bandpass(
	cutoff,
	damping,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_highpass(
	cutoff,
	damping,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_notch(
	cutoff,
	damping,
	order
    ) end
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_lowshelf(
	cutoff,
	damping,
	gain,
	order
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_bandshelf(
	cutoff,
	damping,
	gain,
	order
...
---@param order? integer
---@return AudioVec
function AudioVec:filter_2pole_highshelf(
	cutoff,
	damping,
	gain,
	order
...
---@return AudioVec
function AudioVec:filter_1pole_multinotch(
	cutoff,
	wet_dry,
	order,
	invert
...
---@param invert? boolean
---@return AudioVec
function AudioVec:filter_2pole_multinotch(
	cutoff,
	damping,
	wet_dry,
	order,
...
---@return AudioVec
function AudioVec:mix_variable_gain( 
	start_times, 
	gains 
	) end
...
-- ---@return AudioVec
-- function AudioVec.synthesize_waveform(  
-- 	waveform,
-- 	length, 
-- 	freq, 
-- 	sample_rate,
...
-- ---@param sample_rate? number
-- ---@return AudioVec
-- function AudioVec.synthesize_impulse(
-- 	base_freq,
-- 	num_harmonics,
-- 	chroma,
-- 	sample_rate
...
-- function AudioVec.synthesize_grains( 
-- 	length,
-- 	grains_per_second,
-- 	time_scatter,
-- 	grain_source,
...
---@param sample_rate number
---@return AudioVec
function AudioVec:synthesize_grains_repeat(
	length,
	grains_per_second,
	time_scatter,
	gain,
...
---@param sample_rate? number
---@return AudioVec
function AudioVec:synthesize_grains_with_feedback_mod( 
	length, 
	grains_per_second, 
	time_scatter, 
	mod,
...
-- ---@param sample_rate? number
-- ---@return AudioVec
-- function AudioVec.synthesize_trainlets( 
-- 	length,
-- 	grains_per_second,
-- 	time_scatter,
-- 	position,
...
---@param mod? AudioMod
---@return AudioVec
function AudioVec:synthesize_granulation( 
	length, 
	grains_per_second, 
	time_scatter, 
	time_selection, 
...
---@param mod? AudioMod
---@return AudioVec
function AudioVec:synthesize_psola(
	length, 
	time_selection,
	mod
    ) end
