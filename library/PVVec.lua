...
---@return PVVec
function PVVec.create_null( 
	) end

---Load pv .flan data from a file.
---@param filename string
---@return PVVec
function PVVec.load_from_file( 
	filename
	) end
...
---@return AudioVec
function PVVec:convert_to_audio(  
    ) end

---The inverse transform of Audio::convert_to_ms_PV.
---@return AudioVec
function PVVec:convert_to_lr_audio(  
    ) end

---Creates and saves a bmp spectrograph of the PVVec.
---@param filename string
...
---@return PVVec
function PVVec:modify( 
	mod, 
	interpolator
    ) end

---This is functionally equivalent to using PVVec::modify and only outputting the input time
---@param mod function Second, Frequency -> Frequency
---@param interpolator? Interpolator
---@return PVVec
function PVVec:modify_frequency( 
	mod, 
	interpolator 
    ) end

---This is functionally equivalent to using PVVec::modify and only outputting the input frequency
---@param mod function Second, Frequency -> Second
---@param interpolator? Interpolator
---@return PVVec
function PVVec:modify_time( 
	mod, 
	interpolator
    ) end

---This is functionally equivalent to using PVVec::modify_frequency with the mod output multiplied by input frequency
---@param factor function Second, Frequency -> number
---@param interpolator? Interpolator
---@return PVVec
function PVVec:repitch( 
	factor,
	interpolator
    ) end

---This is functionally equivalent to using PVVec::modifySecond with the mod output multiplied by input time
---@param factor function Second, Frequency -> number
---@param interpolator? Interpolator
---@return PVVec
function PVVec:stretch( 
	factor, 
	interpolator
    ) end

---This is close to PVVec::stretch, but can only expand the input by integer quantities at any given time.
...
---@param interpolator? Interpolator
---@return PVVec
function PVVec:time_extrapolate( 
	start_time, 
	end_time, 
	extrap_time, 
	interpolator
...
---@return PVVec
function PVVec:replace_amplitudes( 
	amp_source, 
	amount
    ) end
...
---@return PVVec
function PVVec:subtract_amplitudes( 
	other, 
	amount
    ) end
...
---@return PVVec
function PVVec:retain_n_loudest_partials( 
	num_partials 
    ) end
...
---@param num_partials number|function Second -> Bin
---@return PVVec
function PVVec:remove_n_loudest_partials( 
	num_partials 
    ) end
